  ...
  return (
    <div className="min-h-[calc(100vh-var(--app-titlebar-h))] bg-background">
      ...
      <div className="px-4 md:px-6 pt-6 md:pt-8">
        <div className="content-width 2xl:mr-[220px] rounded-xl border border-border/60 bg-card p-6 md:p-8 shadow-sm">
      ...
      <div className="px-4 md:px-6 py-4 md:py-6">
        <div className="content-width 2xl:mr-[220px] space-y-4">
