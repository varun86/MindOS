...
function MobileWalkthroughSheet() {
  ...
  return (
    <>
      ...
      {/* Bottom sheet */}
      <div
        className="fixed bottom-0 left-0 right-0 z-app-walkthrough-surface rounded-t-xl border-t shadow-xl p-5 pb-8 animate-in slide-in-from-bottom duration-300"
