...
export default function Panel({
  ...
  return (
    ...
    >
      {/* Home panel — always mounted to preserve the local header mode while navigating around Home. */}
      ...
      <div className={`flex flex-col h-full ${activePanel === 'files' ? '' : 'hidden'}`}>
        ...
        <div
          className="sidebar-scroll-area flex-1 overflow-y-auto min-h-0 px-2 py-2"
