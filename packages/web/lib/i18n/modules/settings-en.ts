...
export const settingsEn = {
  settings: {
    ...
    knowledge: {
      ...
      searchIgnoredTitle: 'Search Ignored Paths',
      searchIgnoredDesc: 'Keep generated folders out of file tree, search, semantic index, and agent context.',
      searchIgnoredPaths: 'Custom ignored paths',
      searchIgnoredPlaceholder: 'Archive/\nPrivate Notes/\n*.tmp',
      searchIgnoredHint: 'Saved to .mindosignore in your knowledge base.',
      searchIgnoredSave: 'Save',
      searchIgnoredReset: 'Reset',
      searchIgnoredSaved: 'Saved to .mindosignore',
      searchIgnoredSaveFailed: 'Failed to save ignored paths',
    ...
    plugins: {
      ...
      managerSubtitle: 'Manage local extensions, imported plugins, and the MindOS surfaces they can use.',
      ...
      catalogInventoryDesc: 'Filter the local plugin inventory without leaving settings.',
      catalogAllFilter: 'All',
      catalogAllFilterDesc: 'Every package MindOS knows about.',
      catalogMindosFilter: 'Built-in',
      catalogMindosFilterDesc: 'Extensions that ship with MindOS.',
      ...
      mindosRenderersDesc: 'MindOS ships these local extensions for notes, boards, logs, links, and structured files.',
      ...
      communityDesc: 'Search Obsidian plugins, check compatibility, then install a disabled local copy.',
      ...
      communityDefaultQueryLabel: 'Default list',
      ...
      marketSubtitle: 'Find Obsidian plugins, check MindOS compatibility, then install a disabled local copy when it is safe to try.',
      ...
      marketResultNote: 'Run Check to see MindOS support. Installed packages stay local and are managed from Settings.',
      marketEmptyHint: 'Try a shorter plugin name, author, or repository search.',
      ...
      marketLocalDesc: 'Local plugin inventory from this MindOS workspace.',
      marketLocalDeferred: 'Open Settings to manage local plugins.',
      marketLocalLoadAction: 'Load local plugins',
      marketLocalEmpty: 'No imported or problem plugins are visible yet.',
      marketLocalLoadFailed: 'Could not load local plugin inventory',
      marketplaceTitle: 'Community plugins',
      openAction: 'Open',
