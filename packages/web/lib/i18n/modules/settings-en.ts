...
export const settingsEn = {
  settings: {
    ...
    plugins: {
      ...
      marketSubtitle: 'Find Obsidian plugins and check MindOS compatibility before installing.',
      ...
      marketResultNote: 'Run Check to see MindOS support. Installed packages stay local.',
