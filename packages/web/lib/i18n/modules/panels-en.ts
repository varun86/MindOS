...
export const panelsEn = {
  ...
  echoPages: {
    ...
    continueRecordLabel: 'Continue writing',
    assistantGenerateImprint: 'Generate imprint',
    ...
    imprintLead: 'Leave one line from what actually happened today. Experience needs to be seen before it can become reflection.',
