...
export const panelsEn = {
  panels: {
    ...
    echo: {
      ...
      imprintTitle: 'Daily Imprint',
      imprintDesc: 'One line and the daily echo',
      threadsTitle: 'Thought Threads',
      threadsDesc: 'Recurring signals and questions',
      growthTitle: 'Self Growth',
      growthDesc: 'Long-term direction and review',
    },
    discover: {
      title: 'Discover',
      useCases: 'Use Cases',
  ...
  echoPages: {
    ...
    snapshotOverviewBody:
      'Leave one imprint, notice the threads that keep returning, then review what you are growing toward.',
    ...
    overviewHeroSubtitle: 'Record · Think · Grow',
    ...
    overviewLead: 'A quiet entry point for today\'s imprint, emerging thought threads, and longer self-growth.',
    imprintLead: 'Write one line about today. Generate a report or keep it for later reflection.',
    ...
    overviewTodayTitle: 'Today',
    overviewTodayBody: 'Leave one line, then decide whether to generate today\'s echo.',
    overviewThreadTitle: 'Recent threads',
    overviewThreadBody: 'See the questions, judgments, and tradeoffs that keep returning.',
    overviewGrowthTitle: 'Season growth',
    overviewGrowthBody: 'Hold the longer direction and revisit it at the end of a stage.',
    overviewOpenImprint: 'Write one line',
    overviewOpenThreads: 'View threads',
    overviewOpenGrowth: 'Update direction',
    overviewMetrics: [
      { label: 'Today imprint', value: '1 line', tone: 'amber' },
      { label: 'Thread signals', value: '3', tone: 'sage' },
      { label: 'Stage direction', value: 'Active', tone: 'graphite' },
    ],
