...
export const panelsEn = {
  ...
  agentsContent: {
    ...
    presets: {
      title: 'Assistant',
      subtitle: 'Manage local Assistant profiles loaded from the hidden MindOS folder.',
      activeLabel: 'Active',
      draftLabel: 'Draft',
      plannedLabel: 'Planned',
      presetRail: 'Assistant profiles',
      promptTitle: 'Prompt file',
      promptHint: 'Edits are written to the selected assistant prompt.md in the local hidden registry.',
      toolsTitle: 'Tools',
      skillsTitle: 'Skills',
      ...
      localRoot: '.mindos/assistants',
      localRootHint: 'Loaded from the local hidden assistant folder.',
      loading: 'Loading assistants...',
      loadFailed: 'Failed to load assistants.',
      retry: 'Retry',
      emptyTitle: 'No local assistants found',
      emptyHint: 'Create .mindos/assistants/<assistant-id>/prompt.md to add one.',
      readyLabel: 'Ready',
      needsPromptLabel: 'Needs prompt',
      promptReadyLabel: 'Prompt ready',
      profileReadyLabel: 'Profile ready',
      localFileLabel: 'Local files',
      localOwnerLabel: 'Local',
      promptMissingHint: 'This assistant does not have a prompt.md yet. Write one here and save it to create the file.',
      ...
      noResources: 'No explicit skills or MCP entries are defined in profile.json yet.',
      notDefinedYet: 'Not defined yet.',
      fileReadyLabel: 'ready',
      fileMissingLabel: 'missing',
