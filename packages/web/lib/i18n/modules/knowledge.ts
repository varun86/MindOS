...
export const knowledgeEn = {
  ...
  inbox: {
    title: 'Inbox',
    subtitle: 'Capture from anywhere, review the queue, then let AI route the right items into your knowledge system.',
    capturePageTitle: 'Capture to Inbox',
    capturePageSubtitle: 'Save text, links, and files first. Review the queue only when you are ready to organize.',
    viewCapture: 'Capture',
    viewQueue: 'Queue',
    viewHistory: 'History',
    quickCaptureTitle: 'New capture',
    quickCaptureDesc: 'Paste notes, article excerpts, meeting fragments, or AI answers. Links and files work too.',
    intentTitle: 'Choose intent',
    intentDesc: 'MindOS accepts any format, but the important question is what this should become.',
    ...
    composerTitle: 'One capture composer',
    composerPlaceholder: 'Paste or drop anything here...',
    composerHint: 'Paste text or a URL, or attach files. Everything lands in Inbox first; AI only runs when you choose AI Organize.',
    captureNoAiHint: 'AI stays off during capture.',
    composerDetected: 'Detected',
    attachButton: 'Attach',
    captureButton: 'Capture to Inbox',
    pendingText: (words: number) => `${words} words`,
    pendingUrl: 'URL',
    pendingFile: 'File',
    clearComposer: 'Clear',
    sourceSignalsTitle: 'Source signals',
    sourceSignalsDesc: 'MindOS looks at format and context only. It does not rewrite anything until you run AI.',
    signalText: 'Text',
    signalUrl: 'URL',
    signalFile: 'File',
    signalLongForm: 'Long form',
    signalConversation: 'AI answer',
    densityTitle: 'Capture type',
    lifecycleTitle: 'Lifecycle',
    lifecycleCaptured: 'Captured',
    lifecycleParsed: 'Parsed',
    lifecycleProposed: 'Proposed',
    lifecycleMerged: 'Merged',
    captureModeLocal: 'Local capture',
    captureModeLocalDesc: 'Saved exactly as provided. No AI required.',
    captureModeAi: 'AI route',
    captureModeAiDesc: 'Reads selected Inbox files and writes organized knowledge.',
    textPlaceholder: 'Paste text, article excerpt, meeting notes, or an AI answer...',
    saveTextButton: 'Save text',
    savingText: 'Saving...',
    textSaved: 'Saved text to Inbox',
    queueTitle: 'Inbox Queue',
    queueEmptyTitle: 'Nothing waiting',
    queueEmptyDesc: 'Drop files, paste links, or write a quick note above.',
    currentItemTitle: 'Current item',
    currentItemEmptyTitle: 'No item selected',
    currentItemEmptyDesc: 'Select an Inbox item to preview routing hints before AI touches the content.',
    safeOrganizeTitle: 'Safe organize plan',
    reviewBeforeWrite: 'Review before write',
    reviewBeforeWriteDesc: 'MindOS shows routing hints first; AI only reads full content when you run organize.',
    keepRawSource: 'Keep raw source',
    keepRawSourceDesc: 'Captured material stays in Inbox until the organize run succeeds.',
    undoRecord: 'Undo record',
    undoRecordDesc: 'Every organize run writes history so changes can be inspected or reverted.',
    understandingTitle: 'Triage plan',
    understandingEmptyTitle: 'Select an item',
    understandingEmptyDesc: 'MindOS shows local routing hints here. AI reads the full content only when you run AI Organize.',
    routeTitle: 'Next action',
    suggestedType: 'Type',
    suggestedTarget: 'Suggested target',
    suggestedReason: 'Reason',
    relatedSignals: 'Related signals',
    actionMerge: 'Run AI Organize',
    actionOpen: 'Open',
    actionRemove: 'Remove',
    actionExtractRule: 'Rule draft',
    actionExtractRuleSoon: 'coming next',
    pipelineCapture: 'Capture',
    pipelineUnderstand: 'Triage',
    pipelineRoute: 'Route',
    pipelineMerge: 'Merge',
    ...
    reasonArticle: 'Looks like external source material; merge it with an existing topic before it becomes noise.',
    reasonMeeting: 'Contains people, dates, or discussion signals; extract decisions and action items.',
    reasonDecision: 'This likely contains a reusable judgment; consider turning it into a rule after review.',
    reasonData: 'Structured content should keep its table shape and be linked from the right Space.',
    reasonDocument: 'Long-form material should be summarized, then routed to the closest Space.',
    reasonRawNote: 'Still ambiguous; keep it staged until MindOS can infer a target from surrounding context.',
    count: (n: number) => `${n}`,
    ...
    organizeNoAi: 'Configure an AI API key before using AI Organize. Capture still works without AI.',
    organizeBusy: 'AI Organize is already running.',
    organizeReadFailed: (failed: number, skipped: number) =>
      `AI Organize started with readable files. ${failed} unreadable and ${skipped} unsupported file${skipped === 1 ? '' : 's'} skipped.`,
    organizeNoReadableFiles: (skipped: number) =>
      `No readable files for AI Organize. ${skipped} unsupported file${skipped === 1 ? '' : 's'} skipped.`,
    aiRouteTitle: 'AI Route',
    modelTitle: 'Model',
    modelFollowSystem: 'Follow system',
    modelNoProvider: 'No provider',
    modelHint: 'Defaults to system AI settings. Choose a provider here only for this Inbox workflow.',
    pendingSequenceTitle: 'Pending',
    recentProcessedTitle: 'Processed',
    queueSidebarTitle: 'Queue + Recent',
    sidebarPanelTitle: 'Inbox workspace',
    sidebarPanelDesc: 'Capture first, then review only when needed.',
    ...
    sidebarHistoryDesc: (n: number) => n === 1 ? '1 organize record.' : `${n} organize records.`,
...
export const knowledgeZh = {
  ...
  inbox: {
    title: 'Inbox',
    subtitle: '先捕获，再审核队列；需要时让 AI 把合适内容归位到知识系统。',
    capturePageTitle: '捕获到 Inbox',
    capturePageSubtitle: '先保存文本、链接和文件；准备整理时再进入队列审核。',
    viewCapture: '捕获',
    viewQueue: '队列',
    viewHistory: '历史',
    quickCaptureTitle: '新捕获',
    quickCaptureDesc: '粘贴想法、文章片段、会议碎片或 AI 回答。链接和文件也可以直接放进来。',
    intentTitle: '选择意图',
    intentDesc: 'MindOS 可以接住任何格式，但真正重要的是：这条内容应该变成什么。',
    nextActionTitle: '下一步',
    ...
    composerTitle: '统一捕获框',
    composerPlaceholder: '粘贴或拖入任何内容...',
    composerHint: '粘贴文本或网址，也可以附加文件。所有内容先进入 Inbox；只有点击 AI 整理时才会运行 AI。',
    captureNoAiHint: '捕获时不会自动运行 AI。',
    composerDetected: '已识别',
    attachButton: '附加',
    captureButton: '捕获到 Inbox',
    pendingText: (words: number) => `${words} 字`,
    pendingUrl: '链接',
    pendingFile: '文件',
    clearComposer: '清空',
    sourceSignalsTitle: '输入信号',
    sourceSignalsDesc: 'MindOS 只先看格式和上下文。只有运行 AI 时才会改写或归位。',
    signalText: '文本',
    signalUrl: '链接',
    signalFile: '文件',
    signalLongForm: '长文',
    signalConversation: 'AI 回答',
    densityTitle: '捕获类型',
    lifecycleTitle: '生命周期',
    lifecycleCaptured: '已捕获',
    lifecycleParsed: '已解析',
    lifecycleProposed: '待确认',
    lifecycleMerged: '已合并',
    captureModeLocal: '本地捕获',
    captureModeLocalDesc: '按原样保存，不需要 AI。',
    captureModeAi: 'AI 归位',
    captureModeAiDesc: '读取暂存内容，并写入整理后的知识。',
    textPlaceholder: '粘贴文本、文章摘录、会议记录，或者一段 AI 回答...',
    saveTextButton: '保存文本',
    savingText: '保存中...',
    textSaved: '文本已保存到 Inbox',
    queueTitle: '待处理队列',
    queueEmptyTitle: '暂无待处理内容',
    queueEmptyDesc: '可以在上方拖入文件、粘贴链接，或写一条快速笔记。',
    currentItemTitle: '当前内容',
    currentItemEmptyTitle: '还没有选择内容',
    currentItemEmptyDesc: '选择一条 Inbox 内容，先预览归位线索，再决定是否让 AI 读取全文。',
    safeOrganizeTitle: '安全归位计划',
    reviewBeforeWrite: '写入前审核',
    reviewBeforeWriteDesc: 'MindOS 先展示归位线索；只有点击整理时，AI 才会读取全文。',
    keepRawSource: '保留原始素材',
    keepRawSourceDesc: '归位成功前，捕获素材会继续留在 Inbox 中。',
    undoRecord: '撤销记录',
    undoRecordDesc: '每次整理都会写入历史，方便检查或撤销变更。',
    understandingTitle: '归位建议',
    understandingEmptyTitle: '选择一条内容',
    understandingEmptyDesc: '这里先展示本地归位线索。只有点击 AI 整理时，AI 才会读取全文。',
    routeTitle: '下一步动作',
    suggestedType: '类型',
    suggestedTarget: '建议位置',
    suggestedReason: '判断理由',
    relatedSignals: '相关信号',
    actionMerge: '运行 AI 整理',
    actionOpen: '打开',
    actionRemove: '移除',
    actionExtractRule: '规则草稿',
    actionExtractRuleSoon: '下一步支持',
    pipelineCapture: '捕获',
    pipelineUnderstand: '初筛',
    pipelineRoute: '归位',
    pipelineMerge: '合并',
    typeArticle: '文章 / 外部资料',
    typeMeeting: '会议或访谈记录',
    ...
    targetData: 'Data / Tables',
    targetInboxReview: 'Inbox review',
    reasonArticle: '看起来是外部资料，适合先和已有主题合并，避免变成孤立素材。',
    reasonMeeting: '包含人物、时间或讨论信号，适合提取决策和行动项。',
    reasonDecision: '这里可能有可复用判断，审核后可以进一步沉淀为规则。',
    reasonData: '结构化内容应保留表格形态，并链接到合适的 Space。',
    reasonDocument: '长文档应先总结，再归位到最接近的 Space。',
    reasonRawNote: '内容还不够明确，先暂存，等待 MindOS 结合上下文判断去向。',
    count: (n: number) => `${n}`,
    ...
    organizeNoAi: '请先配置 AI API 密钥再使用 AI 整理。没有 AI 时仍可正常暂存内容。',
    organizeBusy: 'AI 整理已经在运行。',
    organizeReadFailed: (failed: number, skipped: number) =>
      `AI 已开始整理可读取文件。${failed} 个读取失败，${skipped} 个格式不支持已跳过。`,
    organizeNoReadableFiles: (skipped: number) =>
    ...
    modelHint: '默认使用系统 AI 设置；这里只会覆盖暂存台这一次整理流程。',
    pendingSequenceTitle: '待处理',
    recentProcessedTitle: '已处理',
    queueSidebarTitle: '队列与最近处理',
    sidebarPanelTitle: 'Inbox 工作区',
    sidebarPanelDesc: '先捕获；需要整理时再审核。',
    sidebarCaptureDesc: '保存一条笔记、链接或文件。',
    sidebarLoadingDesc: '队列加载中...',
    sidebarQueueDesc: (n: number) => `${n} 条待处理。`,
    sidebarHistoryDesc: (n: number) => `${n} 条整理记录。`,
    removeFile: '从暂存台移除',
    openFile: '打开',
    copyName: '复制文件名',
