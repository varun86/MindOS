...
export const knowledgeEn = {
  ...
  inbox: {
    title: 'Capture',
    subtitle: 'Capture first. Review the queue, then let AI route the right items into your knowledge system.',
    quickCaptureTitle: 'Capture anything',
    ...
    composerHint: 'PDF, Word, text, URLs, tables, screenshots, AI answers, meeting notes, research fragments.',
    ...
    densityTitle: 'Knowledge density',
    ...
    savingText: 'Saving...',
    textSaved: 'Saved text to Capture',
...
export const knowledgeZh = {
  ...
  inbox: {
    ...
    composerHint: 'PDF、Word、文本、链接、表格、截图、AI 回答、会议记录、研究片段都可以。',
    composerDetected: '已识别',
    attachButton: '附加',
    captureButton: '捕获到暂存台',
