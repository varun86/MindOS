...
export const onboardingEn = {
  ...
  setup: {
    stepTitles: ['Knowledge Base', 'AI Configuration', 'Agent Connection', 'Confirm'],
    // Step 1
    ...
    tokenSectionTitle: 'Auth Token (auto-generated)',
    ...
    agentCliModeTitle: 'CLI mode is ready',
    agentCliModeDesc: 'Agents that can run shell commands can call the mindos CLI directly. Enable MCP only when you want automatic tool discovery.',
    ...
    healthAgentsCliReady: 'CLI mode is ready. Agents with shell access can use MindOS commands directly.',
    healthAgentsCliMcpOptional: 'CLI mode is ready. MCP agents can be added later from Settings → Connections.',
