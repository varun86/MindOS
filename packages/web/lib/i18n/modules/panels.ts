...
export const panelsEn = {
  ...
  agentsContent: {
    ...
    presets: {
      ...
      subtitle: 'Manage the agents MindOS can run from product surfaces.',
      activeLabel: 'Active',
      draftLabel: 'Draft',
      plannedLabel: 'Planned',
      presetRail: 'Built-in agents',
      promptTitle: 'Default prompt',
      promptHint: 'Local draft only. Runtime persistence can be wired later.',
      toolsTitle: 'Tools',
      skillsTitle: 'Skills',
      ...
      launchTitle: 'Run',
      launchHint: 'Start from the product surface this agent owns. Draft and planned agents stay visible but disabled.',
      overviewSection: 'Overview',
      promptSection: 'Prompt',
      resourcesSection: 'Resources',
      libraryHint: 'Choose a built-in agent, then inspect how it runs, what it can touch, and how its prompt is managed.',
      owner: 'Owner',
      runMode: 'Run mode',
...
export const panelsZh = {
  ...
  agentsContent: {
    ...
    presets: {
      title: '内置 Agent',
      subtitle: '管理 MindOS 能在产品界面中调用的 Agent。',
      activeLabel: '已启用',
      draftLabel: '草稿',
      plannedLabel: '计划中',
      presetRail: '内置 Agent',
      promptTitle: '默认 Prompt',
      promptHint: '当前为本地草稿，后续可接入持久化。',
      toolsTitle: '工具',
      skillsTitle: '技能',
      contextTitle: '上下文',
      triggersTitle: '运行入口',
      ...
      contractTitle: '运行契约',
      launchTitle: '运行',
      launchHint: '从该 Agent 归属的产品入口启动。草稿和计划中的 Agent 会显示，但不会误触发。',
      overviewSection: '总览',
      promptSection: 'Prompt',
      resourcesSection: '资源',
      libraryHint: '先选择内置 Agent，再查看它如何运行、能触碰什么、Prompt 如何管理。',
      owner: '归属',
      runMode: '运行方式',
      persistence: '持久化',
      modelPolicy: '模型',
