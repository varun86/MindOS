...
export const OBSIDIAN_CAPABILITY_MATRIX: ObsidianCapabilityRow[] = [
  ...
  },
  {
    ...
    surface: 'unsupported',
    support: 'unsupported',
    host: 'Unsupported native adapter',
    tests: ['obsidian-compat/compatibility-report.test.ts'],
    notes: 'Native filesystem adapter access is not exposed to community plugins.',
  },
];
